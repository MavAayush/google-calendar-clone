    ...
    <div className="flex h-screen flex-col overflow-hidden bg-[var(--color-bg-app)]">
      <header className="flex h-16 items-center justify-between border-b border-[var(--color-border)] bg-[var(--color-surface)] px-6 shadow-sm">
        <div className="flex items-center space-x-6">
          ...
          <button className="rounded-full border border-[var(--color-border)] px-4 py-2 text-sm font-medium hover:border-[var(--color-border-hover)] hover:bg-[var(--color-bg-app)] transition duration-[var(--transition-fast)]">
            Today
          </button>
          <div className="flex items-center space-x-1">
            <button className="p-2 rounded-full hover:bg-[var(--color-bg-app)] text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] transition">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <select className="appearance-none rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] py-2 pl-4 pr-10 text-sm font-medium text-[var(--color-text-main)] hover:border-[var(--color-border-hover)] focus:outline-none transition cursor-pointer">
              <option>Month</option>
              <option>Week</option>
              <option>Day</option>
            </select>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 p-8 flex flex-col justify-center items-center overflow-auto">
